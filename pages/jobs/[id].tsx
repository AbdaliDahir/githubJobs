...
export default function DetailsPage() {
  ...
  return (
    ...
    <div
      ...
      {/* Mobile  */}
      <div className='w-11/12 mx-auto bg-white rounded-md dark:bg-very-dark-blue md:hidden min-h-52'>
        <div
          className='text-white font-brand font-bold mx-auto'>
          {job.company?.[0]}
        </div>
      ...
      <div className='hidden w-11/12 mx-auto overflow-hidden transform -translate-y-8 bg-white rounded-md md:flex min-h-35 max-w-183'>
        <div
          className='grid place-items-center flex-1 text-white'>
